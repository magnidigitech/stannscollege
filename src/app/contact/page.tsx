  ...
  return (
    <div className="min-h-screen bg-slate-50/50 font-sans pb-20 select-none">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#001730] via-[#002147] to-[#0d3b66] text-white pt-12 pb-20 px-6 select-none">
        ...
        {/* Animated & Radial Background Accents */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(99,102,241,0.22),transparent_50%)]" />
        <div className="absolute -left-16 -bottom-16 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl" />
      ...
      <section className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 w-full -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-emerald-50 border border-emerald-200 border-t-4 border-t-emerald-500 shadow-sm hover:shadow-md rounded-[2rem] p-6 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1">
            <div>
          ...
          <div className="bg-blue-50 border border-blue-200 border-t-4 border-t-blue-600 shadow-sm hover:shadow-md rounded-[2rem] p-6 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1">
            <div>
          ...
          <div className="bg-amber-50 border border-amber-200 border-t-4 border-t-amber-500 shadow-sm hover:shadow-md rounded-[2rem] p-6 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1">
            <div>
          ...
          <div className="bg-indigo-50 border border-indigo-200 border-t-4 border-t-indigo-500 shadow-sm hover:shadow-md rounded-[2rem] p-6 transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1">
            <div>
