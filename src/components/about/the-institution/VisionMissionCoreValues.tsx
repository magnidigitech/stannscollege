...
export function VisionMissionCoreValues() {
  ...
  return (
    <div className="flex flex-col gap-12 font-sans select-none animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-900 via-indigo-950 to-indigo-900 p-6 md:p-10 text-white shadow-xl border border-indigo-800/40 select-none">
