    ...
    <div className="flex flex-col gap-12 font-sans select-none animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#001730] via-[#002147] to-[#064e3b] p-6 md:p-10 text-white shadow-xl border border-indigo-950/20 select-none">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/20 backdrop-blur-md border border-emerald-400/30 px-3.5 py-1 text-xs font-bold text-emerald-200 tracking-wider uppercase">
              <Compass className="h-3.5 w-3.5" /> Institutional Distinctiveness
            </span>
