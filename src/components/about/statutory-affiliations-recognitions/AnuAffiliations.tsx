        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-500/20 backdrop-blur-md border border-indigo-400/30 px-3.5 py-1 text-xs font-bold text-indigo-200 tracking-wider uppercase">
              <ShieldCheck className="h-3.5 w-3.5" /> University Affiliation
            </span>
            ...
            <p className="mt-2 text-indigo-100/80 text-xs md:text-sm max-w-xl font-normal leading-relaxed">
              St. Ann’s College for Women, Gorantla, Guntur, is proud to be affiliated with <strong className="text-white font-bold">Acharya Nagarjuna University (ANU)</strong>, a NAAC ‘A’ Grade institution. For the academic year <strong className="text-white font-bold">2025–2026</strong>, the university has granted <strong className="text-white font-bold">Extension of Temporary Affiliation</strong> for both Undergraduate (UG) and Postgraduate (PG) programmes.
            </p>
          </div>
