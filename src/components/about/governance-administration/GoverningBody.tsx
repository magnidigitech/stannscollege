    ...
    <div className="flex flex-col gap-12 font-sans select-none animate-fadeIn">
      ...
      <div className="bg-white border border-slate-200/60 p-6 md:p-10 rounded-3xl shadow-sm hover:shadow-md transition-all font-sans text-slate-600 text-base md:text-lg leading-relaxed">
        ...
        <p className="mt-4 leading-relaxed font-normal text-slate-600">
          The Society of St. Anne, Phirangipuram, traces its roots to the 19th century visionary <strong className="text-indigo-600 font-bold">Mother Thatipatri Gnanamma</strong>. Grounded in this empowering legacy, the institution follows a multi-tiered governance model to fulfill academic goals with strict financial integrity and overarching social responsibility.
        </p>
      </div>
