    ...
    types: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "startDate", title: "1) Start Date (From when it should appear on website)", type: "date" },
          ...
          { name: "pdfFile", title: "Primary Document / PDF", type: "file" },
          {
            name: "documents",
            title: "Additional Documents / PDFs (Multiple Uploads)",
            type: "array",
            of: [
              {
                type: "file",
          ...
          {
            name: "isNew",
            title: "Mark as New (Badge)",
            type: "boolean",
            description: "Shows 'NEW' badge. (Note: The website also automatically shows 'Upcoming' till event date, and 'New' for 3 days after).",
            initialValue: false,
          },
          { name: "displayOrder", title: "Display Order", type: "number" },
        ],
      },
      {
        ...
        fields: [
          ...
          { name: "date", title: "Notice Date (e.g. 2026-09-10 or September 10, 2026)", type: "string" },
          {
            name: "category",
            title: "Category",
            type: "string",
            options: {
              list: [
                { title: "Examinations & Timetables", value: "examinations" },
                { title: "Academic Announcements", value: "academic" },
                { title: "Admissions", value: "admissions" },
                { title: "General Circulars", value: "general" },
                { title: "Student Support & Welfare", value: "student-support" },
                { title: "Placements & Training", value: "placements" },
              ],
            },
          },
      ...
      // ─────────────────────────────────────────────────────────────────
      // FACULTY PROFILE NEW (Unified Schema)
      // ─────────────────────────────────────────────────────────────────
      {
        name: "facultyProfileNew",
        title: "Faculty Profiles New",
        type: "document",
        groups: [
          { name: "basic",       title: "1. Basic Profile" },
          { name: "academic",    title: "2. Academic Qualifications" },
        ...
        fields: [
          { name: "sNo",              title: "S.No / Order",               type: "number",  group: "basic" },
          {
            name: "staffType",
            title: "Staff Type",
            type: "string",
          ...
          { name: "dateOfBirth",      title: "Date of Birth",              type: "date",    group: "basic" },
          { name: "dateOfJoining",    title: "Date of Joining",            type: "string",  group: "basic" },
          {
            name: "employmentType", title: "Employment Type", type: "string", group: "basic",
            options: { list: ["Regular", "Contract", "Visiting", "Adjunct", "Part-Time"], layout: "radio" }
          },
